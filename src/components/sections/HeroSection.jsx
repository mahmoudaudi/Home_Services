...
/* ─── IMAGE POSITION ───────────────────────────────────────────────────────
   ...
   ──────────────────────────────────────────────────────────────────────── */
const IMAGE_TOP = "10px";   // ← change this value only

export default function HeroSection() {
  return (
    <section className="bg-[#142257] text-white relative overflow-hidden flex flex-col min-h-[610px] md:min-h-screen md:pb-14">
      ...
      <div className="flex-1 flex flex-col items-center justify-between text-center
                      px-5 pt-36 sm:pt-40 pb-0">

        {/* Headline + CTA */}
        <div className="flex flex-col items-center w-full max-w-xl pt-2 sm:pt-0 xl:my-auto">
          <p className="text-slate-400 text-[10px] sm:text-xs md:text-sm tracking-[0.12em] font-medium opacity-80">
          ...
          <button className="group mt-8 bg-[#15B2F5] text-white font-bold px-4 sm:px-6 py-2 sm:py-2.5 rounded-full
        ...
        {/* Feature strip */}
        <div className="w-full mt-10 xl:mt-24 pb-0">
